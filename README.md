I have added all the pages one after the other along with nav bar on top to navigate to pages from top, I have made use of grid css so it stays intact across multiple devices.
